...
final class AttributeValidationTest {
    ...
    void rejectsOnclick() {
        ...
        assertTrue(exception.getMessage().contains("onclick"));
        assertTrue(exception.getMessage().contains("blocked by default"));
    }
