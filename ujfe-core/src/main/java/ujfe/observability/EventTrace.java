...
/**
 * Production-safe trace data for one UJFE live event handling attempt.
 */
public final class EventTrace {
    ...
    private final boolean handlerCompleted;

    private EventTrace(Builder builder) {
        ...
        this.handlerFound = builder.handlerFound;
        this.handlerCompleted = builder.handlerCompleted;
    }
    ...
    public boolean handlerCompleted() {
    ...
    public static final class Builder {
        ...
        private boolean handlerFound;
        private boolean handlerCompleted;
        ...
        public Builder eventId(String eventId) {
            this.eventId = blankToNull(eventId);
            return this;
        }
        ...
        public Builder handlerFound(boolean handlerFound) {
            this.handlerFound = handlerFound;
            return this;
        }

        public Builder handlerCompleted(boolean handlerCompleted) {
