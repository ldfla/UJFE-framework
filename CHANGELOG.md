...
- Treated stale live event ids as no-op synchronization requests so delayed or duplicate browser events no longer produce `Unknown UJFE event` server errors.
