...
- Home demonstrates the Java DSL, live server events, browser state access, modal/toast flows, and static asset routing.
- Documentation maps the main framework concepts: `@Page`, `Router`, CSS modes, live endpoints, runtime lifecycle, security defaults, REST usage, and CLI conversion.
